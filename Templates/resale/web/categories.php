...
$sql ="SELECT nome FROM estabelecimento"; 
...
include 'conexao.php';
mysqli_select_db($conexao, "zshopping");
$sqlImg ="SELECT arquivo FROM img_estab"; 
$consultaImg = mysqli_query($conexao, $sqlImg);

if(mysqli_num_rows($consultaImg)==0) {
  echo "<center><h1>Nenhum Registro Encontrado</h1></center>";
   }else{
		  ?>
  ...
  <?php
     	while ($resultado = mysqli_fetch_array($consulta) and $resultadoImg = mysqli_fetch_array($consultaImg)) {
  	 ?>
							...
							<div class="category">
								<div class="category-img">
									<img src="imgs_estabs/<?php $img = $resultadoImg['arquivo']; echo $img?>" title="image" alt="" />
								</div>
                                          <div class="category-info">
									<h4> <?php $nome = $resultado['nome'];echo $nome?></h4>
									<span>2,01,850 Ads</span>
									<a href="all-classifieds.php?estabelecimento=<?php echo $nome?>">Visitar Estabelecimento</a>
								</div>
...
<?php
	...
	?>
							...
							<div class="category">
								<div class="category-img">
									<img src="images/zstore.jpg" title="image" alt="" />
								</div>
