            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" action="ESenha.php" method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="E-mail" name="E_name" type="email" required autofocus>
                                </div>
                               


                                <button type="submit" class="btn btn-lg btn-success btn-block" name="E_enviar">Recover</button>
...
session_start();
$_SESSION['E_email'] = $_POST['E_name'];

$E_email =  $_POST['E_name'];
...
include 'conexao.php';
    ...
    $sql = "SELECT * FROM tb_login WHERE email ='$E_email'";
    ...
    if($retorno == 0){
        ...
        window.location.href= 'ESenha.php'
        </script>
        ";

    }else{
        header('location:alt_senha.php?email='.$E_email);
    }
