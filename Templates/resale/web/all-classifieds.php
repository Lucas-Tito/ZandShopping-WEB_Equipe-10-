...
$sql ="SELECT nome FROM produto WHERE estab ='$estabelecimento'"; 
...
if(mysqli_num_rows($consulta)==0) {
  ...
  <?php
  	 ...
  	 ?>
								...
								<a href="single.html">
									<li>
									<img src="https://fiqueisemcracha.com.br/wp-content/uploads/2016/07/facebook-like-76535_1920-150x150.png" title="" alt="" />
									<section class="list-left">
									<h5 class="title"><?php echo $resultado['nome']; ?> </h5>
